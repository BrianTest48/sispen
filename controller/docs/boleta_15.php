...
$table->addRow();
$table->addCell(3000)->addText("Obra No",'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addCell(3000)->addText("D S No 015-72 TR",'font-md');
$table->addRow();
$table->addCell(3000)->addText("Semana Np",'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addCell(3000)->addText("N°",'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addRow();
$table->addCell(3000)->addText("Nombre",'font-md');
$table->addCell(3000)->addText($nombre_afi,'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addRow();
$table->addCell(3000)->addText("Categoria",'font-md');
$table->addCell(3000)->addText("",'font-md');
$table->addCell(3000)->addText("Ocupacion",'font-md');
$table->addCell(3000)->addText($cargo,'font-md');
$table->addRow();
$table->addCell(3000)->addText("Periodo",'font-md');
$table->addCell(3000)->addText($mes_anio,'font-md');
$table->addCell(3000)->addText("Ingreso",'font-md');
$table->addCell(3000)->addText($fecha_inicio_num,'font-md');

$section->addTextBreak(1);
$table2 = $section->addTable();
$table2->addRow();
$table2->addCell(12000)->addText("Sueldo u Horas de Trabajo",'font-md-ne','text-center');
$section->addTextBreak(1);


$table3 = $section->addTable();
$table3->addRow();
$table3->addCell(3000)->addText("Journal S1",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addCell(3000)->addText("Semanal",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addRow();
$table3->addCell(3000)->addText("Horas Extras",'font-md');
$table3->addCell(3000)->addText($horas_ex,'font-md');
$table3->addCell(3000)->addText("Semanal",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addRow();
$table3->addCell(3000)->addText("Empleado",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addCell(3000)->addText("Obrero",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addRow();
$table3->addCell(3000)->addText("Dominical",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addRow();
$table3->addCell(3000)->addText("Bonificacion",'font-md');
$table3->addCell(3000)->addText($bonif,'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addRow();
$table3->addCell(3000)->addText("Otros",'font-md');
$table3->addCell(3000)->addText($otros,'font-md');
$table3->addCell(3000)->addText("",'font-md');
$table3->addCell(3000)->addText("",'font-md');
...
$table4->addRow();
$table4->addCell(12000)->addText("Remuneraciones",'font-md-ne','text-center');
$section->addTextBreak(1);

$table5 = $section->addTable();
$table5->addRow();
$table5->addCell(3000)->addText("Descuento Ley",'font-md');
$table5->addCell(3000)->addText("Aportaciones",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText($total_boleta,'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("Patrono",'font-md');
$table5->addCell(3000)->addText("Empleado",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("Seguro Social",'font-md');
$table5->addCell(3000)->addText($dsc_ap_ss,'font-md');
$table5->addCell(3000)->addText($dsc_at_ss,'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("Jubilacion",'font-md');
$table5->addCell(3000)->addText($dsc_ap_pen,'font-md');
$table5->addCell(3000)->addText($dsc_at_pen,'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("Acta Trabajo",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("FONAVI",'font-md');
$table5->addCell(3000)->addText($dsc_ap_fon,'font-md');
$table5->addCell(3000)->addText($dsc_at_fon,'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("CONAF",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("Descuentos",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText($total_dsc_at_ap,'font-md');
$table5->addRow();
$table5->addCell(3000)->addText("Saldo a Pagar",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText("",'font-md');
$table5->addCell(3000)->addText($total_neto_bol,'font-md');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi . '-BO15-'.$ruc.'-'.$mes_anio, $writers);
sleep(1);
...
$responseData = array(
    "estado" => 1,
    "archivo" => $nombre_afi .'-BO15-'.$ruc.'-'.$mes_anio
);
