...
$table->addCell(4500)->addText($otros,'font-md');
$table->addRow();
$table->addCell(4500)->addText("VACACIONES:",'font-u-lg');
...
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("APORTACIONES DEL TRABAJADOR",'font-u-lg');
$table->addCell(4500)->addText("",'font-u-lg');
$table->addRow();
...
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("APORTACIONES DEL EMPLEADOR:",'font-u-lg');
$table->addRow();
$table->addCell(4500)->addText("I.P.S.S.:",'font-md');
...
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("--------------------",'font-md','text-center');
$table->addCell(4500)->addText("--------------------",'font-md','text-center');
$table->addRow();
$table->addCell(4500)->addText($nombre_emp,'font-md','text-center');
$table->addCell(4500)->addText("TRABAJADOR",'font-md','text-center');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi . '-BO4-'.$ruc.'-'.$mes_anio, $writers);
sleep(1);
...
$responseData = array(
    "estado" => 1,
    "archivo" => $nombre_afi .'-BO4-'.$ruc.'-'.$mes_anio
);
