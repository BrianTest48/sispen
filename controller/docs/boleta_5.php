...
$table->addRow();
$table->addCell(4000)->addText("Nombre Y Apellidos:",'font-md');
$table->addCell(4000)->addText($nombre_afi,'font-md');
$table->addCell(4000)->addText("",'font-md');
$table->addRow();
$table->addCell(4000)->addText("Cargo:",'font-md');
$table->addCell(4000)->addText($cargo,'font-md');
$table->addRow();
$table->addCell(4000)->addText("Fecha de Ingreso:",'font-md');
$table->addCell(4000)->addText($fecha_inicio,'font-md');
$table->addRow();
$table->addCell(4000)->addText("SUELDO:",'font-md');
$table->addCell(4000)->addText($sueldo,'font-md');
$table->addRow();
$table->addCell(4000)->addText("Rem. Vacacional:",'font-md');
$table->addCell(4000)->addText($rem_vac,'font-md');
$table->addRow();
$table->addCell(4000)->addText("Reintegro:",'font-md');
$table->addCell(4000)->addText($reintegro,'font-md');
$table->addRow();
$table->addCell(4000)->addText("H. Extras:",'font-md');
$table->addCell(4000)->addText($horas_ex,'font-md');
$table->addRow();
$table->addCell(4000)->addText("Bonificacion:",'font-md');
$table->addCell(4000)->addText($bonif,'font-md');
$table->addRow();
$table->addCell(4000)->addText("Otros:",'font-md');
$table->addCell(4000)->addText($otros,'font-md');
$table->addRow();
$table->addCell(4000)->addText("Total:",'font-md');
$table->addCell(4000)->addText($total_boleta,'font-md');
$table->addRow();
$table->addCell(4000)->addText("",'font-md');
$table->addCell(4000)->addText("TRABAJADOR",'font-md');
$table->addCell(4000)->addText("EMPLEADOR",'font-md');
$table->addRow();
$table->addCell(4000)->addText("S.N.P.:",'font-md');
$table->addCell(4000)->addText($dsc_at_pen,'font-md');
$table->addCell(4000)->addText($dsc_ap_pen,'font-md');
$table->addRow();
$table->addCell(4000)->addText("IPSS:",'font-md');
$table->addCell(4000)->addText($dsc_at_ss,'font-md');
$table->addCell(4000)->addText($dsc_ap_ss,'font-md');
$table->addRow();
$table->addCell(4000)->addText("FONAVI:",'font-md');
$table->addCell(4000)->addText($dsc_at_fon,'font-md');
$table->addCell(4000)->addText($dsc_ap_fon,'font-md');
$table->addRow();
$table->addCell(4000)->addText("QUINCENA:",'font-md');
$table->addCell(4000)->addText("",'font-md');
$table->addCell(4000)->addText("",'font-md');
$table->addRow();
$table->addCell(4000)->addText("ADELANTO:",'font-md');
$table->addCell(4000)->addText("",'font-md');
$table->addCell(4000)->addText("",'font-md');
$table->addRow();
$table->addCell(4000)->addText("OTROS:",'font-md');
...
$table->addCell(4000)->addText("",'font-md');
$table->addRow();
$table->addCell(4000)->addText("TOTAL DSCTO.:",'font-md');
$table->addCell(4000)->addText($tot_dsc_at,'font-md');
$table->addCell(4000)->addText($tot_dsc_ap,'font-md');
$table->addRow(4);
$table->addCell(4000)->addText("",'font-md');
$table->addCell(4000)->addText("NETO A PAGAR",'font-md');
$table->addCell(4000)->addText($total_neto_bol,'font-md');

$table->addRow();
$table->addCell(6000)->addText("--------------------",'font-md','text-center');
$table->addCell(6000)->addText("--------------------",'font-md','text-center');

$table->addRow();
$table->addCell(6000)->addText($nombre_emp,'font-md','text-center');
$table->addCell(6000)->addText("TRABAJADOR",'font-md','text-center');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi . '-BO5-'.$ruc.'-'.$mes_anio, $writers);
sleep(1);
...
$responseData = array(
    "estado" => 1,
    "archivo" => $nombre_afi .'-BO5-'.$ruc.'-'.$mes_anio
);
