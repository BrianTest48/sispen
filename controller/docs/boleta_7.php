...
$section->addText('BOLETA DE PASO DE REMUNERACIONES','font-u-lg','text-center');
$section->addTextBreak(0);
$section->addText($mes_anio,'font-md','text-center');
...
$table->addCell(4500)->addText("Carnet S.B.:",'font-md');
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("Nombres",'font-md');
$table->addCell(4500)->addText("",'font-md');
$table->addCell(4500)->addText("Dias Trabajados",'font-md');
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("Cargo",'font-md');
$table->addCell(4500)->addText($cargo,'font-md');
$table->addCell(4500)->addText("Dias Descansado",'font-md');
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("Ingreso",'font-md');
$table->addCell(4500)->addText($fecha_inicio,'font-md');
$table->addCell(4500)->addText("Dias Feriado",'font-md');
$table->addCell(4500)->addText("",'font-md');
$table->addRow();
$table->addCell(4500)->addText("",'font-md');
$table->addCell(4500)->addText("",'font-md');
$table->addCell(4500)->addText("Feriado Trabajado",'font-md');
$table->addCell(4500)->addText("",'font-md');
...
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText($dsc_ap_fon,'font-md','text-right');
$table2->addCell(3000, ['valign' => 'center', 'cellMargin' => 80, 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText($dsc_at_fon,'font-md','text-right');

$table2->addRow();
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("ASIG. FAMILIA",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText(" ",'font-md');
...
$table2->addRow();
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("ALIMENTAC-RD",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText(" ",'font-md');
...
$table2->addRow();
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("BONO",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText(" ",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText(" ",'font-md');
$table2->addCell(3000, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText(" ",'font-md');
...
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("0.00",'font-md');
$table2->addCell(3000, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("0.00",'font-md');


$table2->addRow();
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("TOTALES",'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText($total_boleta,'font-md');
$table2->addCell(1500, ['valign' => 'center', 'borderSize' => 4, 'border-style' => 'single', 'borderColor' => '000000'])->addText("NETO A PAGAR S.A.",'font-md');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi . '-BO7-'.$ruc.'-'.$mes_anio, $writers);
sleep(1);
...
$responseData = array(
    "estado" => 1,
    "archivo" => $nombre_afi .'-BO7-'.$ruc.'-'.$mes_anio
);
