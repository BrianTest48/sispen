...
$section->addText('Se CERTIFICA: ','font-u-md','indtStyle-le-min');
$section->addText('Al trabajador : '.$nombre_afi.' quien laboró como '.$cargo.' durante el tiempo :','font-md','indtStyle-left');
$section->addText('Fecha de Ingreso : '.$fecha_inicio,'font-md','indtStyle-le-min');
$section->addText('Fecha de Cese : '.$fecha_final,'font-md','indtStyle-le-min');
$section->addText('Durante el tiempo que estuvo bajo nuestra dependencia se distingue por ser puntual, responsable de sus actos y honradez a toda prueba.','font-md','indtStyle-left');
$section->addText('Se le extiende este documento para los fines que le convenga.','font-md','indtStyle-left');
...
//exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G1-'.$ruc, $writers);
