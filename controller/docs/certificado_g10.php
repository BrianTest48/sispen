...
$section->addText($nombre_emp,'font-lg','text-center');

$section->addTextBreak(4);
$section->addText('CERTIFICADO DE TRABAJO','font-lg-negrita','text-left');

$section->addTextBreak(1);
$section->addText('El funcionario que suscribe, hace constar que: '.$nombre_afi.', ha laborado a favor nuestro en el cargo de '.$cargo.' con fecha de Ingreso: '.$fecha_inicio.' Fecha de Salida : '.$fecha_final.'.','font-md','indtStyle-left');
$section->addTextBreak(1);
$section->addText('Desarrollando sus actividades a nuestra completa y entera satisfaccion con disciplina, buena conducta y honradez. ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Se le otorga para los fines del caso.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G10-'.$ruc, $writers);
sleep(1);
