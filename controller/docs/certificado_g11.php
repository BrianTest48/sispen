...
$section->addText('El suscrito de conformidad a las leyes laborales en vigencia hace constatar que: ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('               El trabajador: '.$nombre_afi.' ha laborado como: '.$cargo.' en el periodo: '.$fecha_inicio.' hasta el: '.$fecha_final.' siendo su último cargo '.$cargo.'.','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('               Durante el tiempo de servicio, se distingue por su puntualidad, eficiencia y desempeño laboral conforme a los alineamientos de la empresa. ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('               Se expide para los fines que sean necesarios.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G11-'.$ruc, $writers);
sleep(1);
