...
$phpWord->addParagraphStyle('indtStyle-left', array('align'=>'both','indentation' => array('left' => 1400, 'right'=> 900), 'spacing'=>150));
...
$section->addText('C e r t i f i c a d o','font-lg-negrita','text-center');
$section->addText('d e','font-lg-negrita','text-center');
$section->addText('T r a b a j o','font-lg-negrita','text-center');

$section->addTextBreak(1);
$section->addText('Que, de nuestros archivos se acredita que la persona de '.$nombre_afi.' ha prestado servicios en el cargo de '.$cargo.', desde el '.$fecha_inicio.' hasta '.$fecha_final.', que se retira voluntariamente.','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Se deja constancia que el trabajador durante su dependencia demostró eficiencia, puntualidad, dedicación exclusiva a las labores encomendadas, por o que se le otorga este documento para los fines que le puede convenir.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G12-'.$ruc, $writers);
sleep(1);
