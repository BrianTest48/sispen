...
$section->addText('CONSTANCIA DE SERVICIO LABORAL','font-lg-negrita','text-center');

$section->addTextBreak(1);
$section->addText('El representante legal de la empresa conforme a las leyes laborales en vigencia. ','font-md','indtStyle-left');

$section->addTextBreak(2);
$section->addText('C E R T I F I C A','font-u-lg','indtStyle-left');

$section->addTextBreak(1);
$section->addText('A Don: '.$nombre_afi.'que se desempeñó como empleado , ejerciendo el cargo de: '.$cargo.' en el periodo comprendido del '.$fecha_inicio.' hasta el '.$fecha_final.', fecha que hizo su retiro voluntariamente.','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Se deja establecido que durante el ejercicio de sus funciones se distinguió por su puntualidad, laboriocidad recibiendo felicitaciones por parte para los usos o fines que tenga por conveniente.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G3-'.$ruc, $writers);
sleep(1);
