...
$section->addText('El personal directivo de la empresa que suscribe C E R T I F I C A:','font-md','indtStyle-left');
$section->addText('              Que, el Sr: '.$nombre_afi.' estuvo laborando a favor nuestro en el periodo comprendido desde el '.$fecha_inicio.' hasta el '.$fecha_final.' retirandose mediante carta notarial.','font-md','indtStyle-left');
$section->addText('              Nuestro trabajador tuvo un desempeño satisfactorio en el Cargo de '.$cargo.' siendo felicitado en reiteradas oportunidades por lo que se le extiende este certificado para los usos que estime conveniente.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G4-'.$ruc, $writers);
sleep(1);
