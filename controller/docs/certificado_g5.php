...
$section->addText('CONSTANCIA DE LABORES','font-lg-negrita','text-center');

$section->addTextBreak(1);
$section->addText('EL PERSONAL REPRESENTANTE LEGAL DE LA EMPRESA CERTIFICA: ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Al Sr. '.$nombre_afi.' Por haber laborado a nuestro favor en el cargo de: '.$cargo.'.','font-md','indtStyle-left');

$section->addText('Desde : '.$fecha_inicio,'font-md','indtStyle-left');
$section->addText('Hasta : '.$fecha_final,'font-md','indtStyle-left');
$section->addText('Retirandose voluntariamente por rzones personales.','font-md','indtStyle-left');
$section->addText('Expedimos este documento solicitado por la parte interesada para los fines que estime necesario..','font-md','indtStyle-left');

$section->addTextBreak(3);
$section->addText($fecha_footer,'font-md','text-right');
$section->addTextBreak(3);
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G5-'.$ruc, $writers);
sleep(1);
