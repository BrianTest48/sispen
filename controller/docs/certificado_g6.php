...
$section->addText('SE CERTIFICA: A '.$nombre_afi.' en el cargo de '.$cargo.', durante el tiempo comprendido desde '.$fecha_inicio.' hasta '.$fecha_final.', fecha que hace su renuncia voluntaria.','font-md','indtStyle-left');
$section->addTextBreak(1);
$section->addText('Cuando estuvo bajo nuestra dependencia se distinguió por su alto sentido de responsabilidad, eficiencia y discreción. ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Se le expide el presente documento a solicitud verbal de la parte interesada para los fines que estime por conveniente.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G6-'.$ruc, $writers);
sleep(1);
