...
$section->addText('SE CERTIFICA: A '.$nombre_afi.' quien ha laborado en nuestra representada, como '.$cargo.', durante el periodo que comprende desde '.$fecha_inicio.' hasta '.$fecha_final.'.','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Cuando estuvo bajo nuestra dependencia su labor fue satisfactoria, en todo momento apoyó en los trabajos encomendados, siendo pntual, con una honradez acrisolada. '.$cargo,'font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Se emite este documento en concordancia con lo dispuesto a las leyes laborales.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G7-'.$ruc, $writers);
sleep(1);
