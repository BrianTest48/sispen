...
$section->addText('CONSTANCIA LABORAL','font-lg-negrita','indtStyle-left');

$section->addTextBreak(1);
$section->addText('El que suscribe deja establecido que '.$nombre_afi.', ha trabajado como '.$cargo.' con fecha de ingreso: '.$fecha_inicio.' y de salida '.$fecha_final.'.','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Durante el tiempo de su permanencia fue una persona disciplinada de buena conducta y una honradez a toda prueba. ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('A solicitud de la parte interesada se le otorga este documento.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G8-'.$ruc, $writers);
sleep(1);
