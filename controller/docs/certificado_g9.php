...
$section->addText('El funcionario del rubro deja constancia que la persona de '.$nombre_afi.' fue trabajador de nuestra representada con fecha de ingreso: '.$fecha_inicio.' hasta: '.$fecha_final.' siendo  su último cargo '.$cargo.'.','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Durante el desempeño de sus actividades fue un personal eficiente de espiritu de superación, diligente y honradez. ','font-md','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Se le otorga para los fines que estime conveniente.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-G9-'.$ruc, $writers);
sleep(1);
