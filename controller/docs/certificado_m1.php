...
$section->addText('CONSTANCIA DE TRABAJO','font-lg-negrita','indtStyle-left');
$section->addTextBreak(1);

$section->addText('                                   Se deja constancia que : '.$nombre_afi.' ha prestado servicios en el cargo de '.$cargo.', desde el '.$fecha_inicio.' hasta el '.$fecha_final.', fecha que se retira mediante carta de retiro.', 'font-md-justificado','indtStyle-left');
$section->addTextBreak(1);
$section->addText('                                   Se le otorga en agradecimiento a los servicios prestados para los que crea conveniente.','font-md-justificado','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CM1-'.$ruc, $writers);
sleep(1);
