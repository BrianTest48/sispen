...
$phpWord->addParagraphStyle('indtStyle-left', array('align'=>'both','indentation' => array('left' => 1500, 'right'=> 900), 'spacing'=>150));
...
$section->addText('Se certifica: A '.$nombre_afi. ' quien ha laborado desde el '.$fecha_inicio.' hasta el '.$fecha_final.' ,desempeñando el cargo de: '.$cargo,'font-md','indtStyle-left');
$section->addTextBreak(1);
$section->addText('Durante el tiempo que trabajó se distinguió por su puntualidad, sentido de responsabilidad y eficiencia.','font-md','indtStyle-left');
$section->addTextBreak(1);
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CM2-'.$ruc, $writers);
sleep(1);
//echo "1";
