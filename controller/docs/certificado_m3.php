...
$phpWord->addFontStyle('font-md', array('bold'=>false, 'italic'=>false, 'size'=>13));
...
$section->addText('A favor de '.$nombre_afi. ' quién laboró como '.$cargo.' desde '.$fecha_inicio.' hasta '.$fecha_final,'font-md','indtStyle-left');
$section->addTextBreak(1);
$section->addText('Durante el periodo que estuvo bajo nuestra dependencia se distinguió por su puntualidad, dedicación exclusiva a las labores encomendadas y honradez a toda prueba.','font-md','indtStyle-left');
$section->addText('Se le otorga este documento para los fines del caso.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CM3-'.$ruc, $writers);
sleep(1);
