...
$section->addText('C O N S T A N C I A','font-lg-negrita','text-center');

$section->addTextBreak(1);
$section->addText('Se Certifica: A: '.$nombre_afi. ', al haberse desempeñado como empleado en el cargo de: '.$cargo.', desde '.$fecha_inicio.' hasta '.$fecha_final.', fecha en que se retira voluntariamente por motivos particulares, desempeñándose a nuestra entera y completa satisfacción.','font-md','indtStyle-left');
$section->addText('Se le extiende el documento a la parte interesada para los usos que estime necesario.','font-md','indtStyle-left');
