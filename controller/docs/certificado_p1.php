...
// Ruta al archivo de fuente personalizada (reemplázala con la ruta real a tu archivo de fuente)
...
$phpWord->addParagraphStyle('indtStyle-left', array('align'=>'left','indentation' => array('left' => 900, 'right'=> 900), 'spacing'=>150));
...
$section->addText('EL QUE SUSCRIBE DEJA CONSTANCIA QUE: '.$nombre_afi.' ha desarrollado sus actividades laborales como : '.$cargo.'.','font-md','indtStyle');
$section->addText('Desde : '.$fecha_inicio,'font-md','indtStyle');
$section->addText('Hasta : '.$fecha_final,'font-md','indtStyle');
$section->addText('Se le expide este documento para los fines necesarios','font-md','indtStyle');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CP1-'.$ruc, $writers);
sleep(1);
