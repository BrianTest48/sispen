...
$phpWord->addParagraphStyle('indtStyle-left', array('align'=>'both','indentation' => array('left' => 1800, 'right'=> 900), 'spacing'=>150));
...
$section->addText($nombre_emp,'font-lg','indtStyle-le-min');
$section->addText($ruc,'font-sm','indtStyle-le-min');

$section->addTextBreak(4);
$section->addText('CERTIFICADO DE TRABAJO :','font-lg-negrita','indtStyle-le-min');

$section->addTextBreak(1);
$section->addText('El que da fe a la presente certifica a '.$nombre_afi.' quien ha laborado al servicio nuestro desde '.$fecha_inicio.' hasta '.$fecha_final.'. Fecha que se retira voluntariamente siendo su último cargo: '.$cargo.'.','font-md','indtStyle-left');
$section->addText('Se le expide a solicitud del interesado para los fines que le pueda convenir.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CP3-'.$ruc, $writers);
sleep(1);
