...
$section->addText('CERTIFICADO DE TRABAJO','font-lg-negrita','text-center');

$section->addTextBreak(1);
$section->addText('El que suscribe la presente C E R T I F I C A: ','font-md','indtStyle-left');
$section->addText('              Que, '.$nombre_afi.' ha laborado en el cargo de: '.$cargo.' en el periodo comprendido desde '.$fecha_inicio.' hasta '.$fecha_final.', fecha que se retira voluntariamente mediante carta notarial.','font-md','indtStyle-left');
$section->addText('Durante su permanencia ha demostrado eficiencia, puntualidad y espiritu de superacion.','font-md','indtStyle-left');
$section->addText('Se le expide el presente a solicitud verbal del interesado para los fines que convengan','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CP4-'.$ruc, $writers);
sleep(1);
