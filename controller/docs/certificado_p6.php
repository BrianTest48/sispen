...
$section->addText('CONSTANCIA DE TRABAJO','font-lg-negrita','text-center');

$section->addTextBreak(1);
$section->addText('Se Certifica : ','font-u-md','indtStyle-left');
$section->addText('              Que el Sr. '.$nombre_afi.' se desempeñó como '.$cargo.' en el periodo desde :'.$fecha_inicio.' hasta '.$fecha_final.'.','font-md','indtStyle-left');
$section->addText('              Durante el tiempo que laboró demostró puntualidad, eficiencia espiritu de superación.','font-md','indtStyle-left');
$section->addText('              Se le otorga este documento para los usos que estime conveniente.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CP6-'.$ruc, $writers);
sleep(1);
