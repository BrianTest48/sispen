...
$phpWord->addParagraphStyle('indtStyle-left', array('align'=>'both','indentation' => array('left' => 1600, 'right'=> 900), 'spacing'=>150));
...
$section->addText('Certificado Laboral','font-lg-negrita','indtStyle-le-min');

$section->addTextBreak(1);
$section->addText('Se Certifica a: '.$nombre_afi.' por haber laborado desde el '.$fecha_inicio_num.' hasta el '.$fecha_final_num.', siendo su ultimo cargo '.$cargo.'.','font-md','indtStyle-left');
$section->addText('Durante el desarrollo de sus actividades, fue felicitado en reiteradas oportunidades, distinguiendose por su puntualidad, honradez y dedicacion exclusiva a las labores encomendadas.','font-md','indtStyle-left');
$section->addText('Se le extiende para los fines del caso.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CP7-'.$ruc, $writers);
sleep(1);
