...
$section->addText('Se CERTIFICA A: '.$nombre_afi.' quien trabajó en el cargo de '.$cargo.' con fecha de ingreso el '.$fecha_inicio_num.' y fecha de cese '.$fecha_final_num.', retirandose voluntariamente mediante aviso notarial.','font-md','indtStyle-left');
$section->addText('Se le extiende para los fines que estime conveniente.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-CP8-'.$ruc, $writers);
sleep(1);
