...
$section->addTextBreak(1);
$section->addText('RECIBO:','font-sm','text-left');
$section->addText('He recibido de '.$nombre_emp.', la suma de: '.$monto_letra.' INTIS, en cancelacion de mis derechos y beneficios sociales que me corresponden de acuerdo a Ley, según la Liquidación que antecede y con lo que queda concluida mi relación laboral con dicha empresa.','font-sm','text-just');
$section->addText('Dejo constancia que me encuentro de acuerdo con lo calculado por mi Tiempo de Servicios elaborado por la Empresa, firmando la presente, no teniendo nada que reclamar en un futuro dado.','font-sm','text-just');
$section->addTextBreak(1);
