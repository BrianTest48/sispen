...
$section->addText($nombre_emp,'font-md','indtStyle-right');
$section->addText($fecha_footer,'font-md','indtStyle-right');

$section->addTextBreak(2);
$section->addText('Asunto: Renuncia ','font-lg-negrita','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Estimado Sr: ','font-lg-negrita','indtStyle-left');

$section->addTextBreak(1);
$section->addText('Me dirijo a usted en la oportunidad de hacer de su conocimiento que he decidido dar por terminado mi contrato de trabajo con esta empresa, suscrito el '.$fecha_inicio,'font-md','indtStyle-left');
$section->addText('Llego a esta decisión por causa justa imputable a la empresa, toda vez que '.$nombre_emp.' ha incumplido reiteradamente su obligación de cancelar oportunamente los beneficios laborales establecidos en mi contrato.','font-md','indtStyle-left');
$section->addText('Tomando en consideracion que la situación expuesta afecta considerablemente mis interes e integridad, considero debidamente justificada mi decision de dar por terminada la relación laboral.','font-md','indtStyle-left');
$section->addTextBreak(1);
$section->addText('Sin mas qué agregar, me despido','font-md','text-center');
$section->addTextBreak(1);
$section->addText('Atentamente','font-md','text-center');


$section->addTextBreak(3);
$section->addText($nombre_afi,'font-md','text-center');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-R1-'.$ruc, $writers);
sleep(1);
