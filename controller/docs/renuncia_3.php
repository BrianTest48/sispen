...
$section->addText('Carta de Renuncia','font-md','text-center');
$section->addTextBreak(1);

$section->addText('Señor director/a:','font-md','indtStyle-left');

$section->addTextBreak(3);

$section->addText('Por medio de esta carta, yo '.$nombre_afi.', deseo comunicarle mi renuncia voluntaria a mi puesto de '.$cargo.' en la empresa, cargo que llevo desempeñando desde el día '.$fecha_inicio.', así como esta establecido en mi contrato.','font-md','indtStyle-left');
$section->addText('Ya que la ley establece que debo anunciar mi renuncia con días de anticipación, les informo que hasta el dia '.$fecha_final.' trabajare en '.$nombre_emp.'.','font-md','indtStyle-left');
$section->addText('Me despido, no sin antes agradecerle la oportunidad de haber trabajado en esta institucion como '.$cargo.', el cial me permitió impartir, mis conocimientos y experiencia laboral a los demás.','font-md','indtStyle-left');
$section->addText('Sin nada mas que añadir, atentamente.','font-md','indtStyle-left');




$section->addTextBreak(3);
$section->addText('_____________________','font-md','text-center');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-R3-'.$ruc, $writers);
sleep(1);
