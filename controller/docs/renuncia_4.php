...
$section->addText('Estimado(a):','font-md','indtStyle-left');

$section->addTextBreak(2);

$section->addText('A través del presente escrito, deseo manifestar mi renuncia al puesto de trabajo que hasta ahora ocupo en la empresa. Dicha decisión responde a motivos personales, por lo que agradezp todos los aprendizajes y experiencias que enriquecieron mi formación, producto del tiempo que aquí laboré.','font-md','indtStyle-left');
$section->addText('Deseo siempre lo mejor para la empresa y para cada uno de mis compañeros de trabajo.','font-md','indtStyle-left');
$section->addText('Sin más que agregar, esperando que sean comprendidas las razones antes expuestas.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-R4-'.$ruc, $writers);
sleep(1);
