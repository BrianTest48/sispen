...
$section->addText('CARTA DE RENUNCIA INMEDIATA','font-lg','text-center');
...
$section->addText('Gerente de Recursos Humanos','font-md','indtStyle-left');
$section->addTextBreak(1);
$section->addText('Asunto: Carta de Renuncia','font-md','indtStyle-left');

$section->addTextBreak(2);

$section->addText('Reciba un cordial saludo. A través de la presente, yo '.$nombre_afi.' con número de identidad N° '.$dni.' renuncio de fomra inmediata e irrevocable al puesto de '.$cargo.' que ocupo en esta empresa.' ,'font-md','indtStyle-left');
$section->addText('El motivo de mi renuncia esta relacionado con el ambiente poco ético y agresivo que se desarrolla en el área en la que trabajo. Allí, recibo constantes amenazas y humillaciones de mi jefe inmmediato, Gerente de Producción.','font-md','indtStyle-left');
$section->addText('Por este motivo, dejaré de prestar servicios en esta compañía.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-R5-'.$ruc, $writers);
sleep(1);
