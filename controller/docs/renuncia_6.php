...
$section->addText('Permita aceptar esta carta como notificación de mi renuncia al puesto de '.$cargo.' en '.$nombre_emp.'.' ,'font-md','indtStyle-left');
$section->addText('De acuerdo con los términos de mi contrato de trabajo, continuaré trabajando para la compañia durante los proximos dias, siendo el ultimo dia de mi empleo el '.$fecha_final.'.' ,'font-md','indtStyle-left');
$section->addText('Sinceramente','font-md','indtStyle-left');
