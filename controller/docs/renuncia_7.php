...
$section->addText('Estimados integrantes de la directiva:','font-u-md','indtStyle-left');
$section->addText('Yo, '.$nombre_afi.' por este medio quiero presentar a modo formal mi renuncia, a partir del '.$fecha_final.', al cargo de '.$cargo.'.' ,'font-md','indtStyle-left');
$section->addText('Quiero dejar constancia de mi agradecimiento por la oportunidad que me brindaron de ejercer este cargo en beneficio de nuestra comunidad, y por la confianza que depositaron en mí.' ,'font-md','indtStyle-left');


$section->addTextBreak(3);
$section->addText('Un saludo cordial.','font-md','indtStyle-left');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-R7-'.$ruc, $writers);
sleep(1);
