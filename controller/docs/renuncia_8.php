...
$section->addText('CARTA DE RENUNCIA','font-u-md','text-center');


$section->addTextBreak(2);
$section->addText('Yo, '.$nombre_afi.', portador con el DNI N° '.$dni.', mediante la presente notifico mi voluntad de renunciar al cargo de '.$cargo.' de la empresa '.$nombre_emp.', que he venido desempeñando hasta la presente fecha, en tal sentido dejo a disposición el mismo para que puedan realizarse nuevas elecciones.','font-md','indtStyle-left');
$section->addText('Sin otro particular a que hacer referencia se despide.','font-md','text-center');
$section->addText('Atentamente','font-md','text-center');

$section->addTextBreak(3);
$section->addText('____________________','font-md','text-center');
...
exportarWord::write($phpWord, $directorio . $nombre_carpeta, $nombre_afi.'-R8-'.$ruc, $writers);
sleep(1);
