            ...
            if(empty($_POST["lista"])){
                if(is_array($datos)==true and count($datos)==0){
                    ...
                    $lista_rpt->insert_lista_reporte_pension($_POST["af_id"], $_POST["documento"], $_POST["txtcant_emp"], $_POST["txtcant_orcinea"], $_POST["txtcant_host"],$_POST["tipo"], $_POST["txtdate"], 
                        $_POST["f_inicio_orc_1"], $_POST["f_final_orc_1"], $_POST["ruc_orc_1"], $_POST["cargo_orc_1"], $_POST["firmante_orc_1"], $_POST["logo_orc_1"],
                        $_POST["f_inicio_orc_2"], $_POST["f_final_orc_2"], $_POST["ruc_orc_2"], $_POST["cargo_orc_2"], $_POST["firmante_orc_2"], $_POST["logo_orc_2"],
                        $_POST["f_inicio_orc_3"], $_POST["f_final_orc_3"], $_POST["ruc_orc_3"], $_POST["cargo_orc_3"], $_POST["firmante_orc_3"], $_POST["logo_orc_3"],
                        $_POST["f_inicio_orc_4"], $_POST["f_final_orc_4"], $_POST["ruc_orc_4"], $_POST["cargo_orc_4"], $_POST["firmante_orc_4"], $_POST["logo_orc_4"],
                        $_POST["f_inicio_ht_1"], $_POST["f_final_ht_1"], $_POST["ruc_ht_1"], $_POST["cargo_ht_1"], $_POST["firmante_ht_1"], $_POST["logo_ht_1"], 
                        $_POST["f_inicio_ht_2"], $_POST["f_final_ht_2"], $_POST["ruc_ht_2"], $_POST["cargo_ht_2"], $_POST["firmante_ht_2"], $_POST["logo_ht_2"], 
                        $_POST["f_inicio_ht_3"], $_POST["f_final_ht_3"], $_POST["ruc_ht_3"], $_POST["cargo_ht_3"], $_POST["firmante_ht_3"], $_POST["logo_ht_3"], 
                        $_POST["f_inicio_ht_4"], $_POST["f_final_ht_4"], $_POST["ruc_ht_4"], $_POST["cargo_ht_4"], $_POST["firmante_ht_4"], $_POST["logo_ht_4"], $_POST["meses_rfx"],
                        ...
                        $_POST["f_inicio_5"], $_POST["f_final_5"], $_POST["ruc_emp5"], $_POST["cargoc5"], $_POST["firmante5"], $_POST["logo5"],
                    );
                    echo(1);
