        ...
        <div class="br-mainpanel">
            <div class="br-pageheader pd-y-15 pd-l-20">
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Bono</span>
                </nav>
            </div><!-- br-pageheader -->
                <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 class="tx-gray-800 mg-b-5">Bono Automático</h4>
                <p class="mg-b-0">Realiza las bonos con los siguientes datos.</p>
            </div>
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    <div class="row justify-content-between">
                        <div class="col-12 col-sm-6">
                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Formulario de Bonos</h6>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <input type="hidden" id="tipo_lista" name="tipo_lista" value="BONO">
                            <form method="post" id="bono_form">
                                ...
                                <div class="d-none" id="form_datos">
                                        ...
                                        <div class="form-layout-footer text-center">
                                            ...
                                            <button type="button" id="btnlimpiar" name="" class="btn btn-secondary">Limpiar</button>
                        ...
                        <div class="col-xl-6" >
                            <div class="form-layout form-layout-1" id="temp_servicio">
                               ...
                               <h6 class="text-center mg-t-10">Tiempo de Bono : <label id="tiempo_bono"></label></h6>
                            </div>
                            <br>
                                    ...
                                    <div id="certificado" class="tab-pane fadein show active">
                                        <form id="form_certificado" action="" method="post" autocomplete="off">
                                                        ...
                                                        <div class="row mg-b-5">
                                                            ...
                                                            <div class="col-lg-6 pd-0">
                                                                <select class="form-control col-lg-6 select2" data-placeholder="Seleccione" id="select_certificado"  style="width: 100%" >
                                                                    ...
                                                                    <option value="4">Certificado - 4</option>
                                                                    <option value="5">Certificado - 5</option>
                                                                    <option value="6">Certificado - 6</option>
                                                                    <option value="7">Certificado - 7</option>
                                                                    <option value="8">Certificado - 8</option>
                                                                    <option value="9">Certificado - 9</option>
                                                                    <option value="10">Certificado - 10</option>
                                                                    <option value="11">Certificado - 11</option>
                                                                    <option value="12">Certificado - 12</option>
                                                                    <option value="13">Certificado - 13</option>
                                                                    <option value="14">Certificado - 14</option>
                                                                    <option value="15">Certificado - 15</option>
                                                                    <option value="16">Certificado - 16</option>
                                                                    <option value="17">Certificado - 17</option>
                                                                    <option value="18">Certificado - 18</option>
                                                                    <option value="19">Certificado - 19</option>
                                                                    <option value="20">Certificado - 20</option>
                                                                    <option value="21">Certificado - 21</option>
                                                                    <option value="22">Certificado - 22</option>
                                                                    <option value="23">Certificado - 23</option>
                                                                    <option value="24">Certificado - 24</option>
                                                                    <option value="25">Certificado - 25</option>
                                                                    <option value="26">Certificado - 26</option>
                                                                    <option value="27">Certificado - 27</option>
                                                                    <option value="28">Certificado - 28</option>
                                                                    <option value="29">Certificado - 29</option>
                                                                    <option value="30">Certificado - 30</option>
                                                                    <option value="31">Certificado - 31</option>
                                                                    <option value="32">Certificado - 32</option>
                                                                    <option value="33">Certificado - 33</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div> 
                                            ...
                                            <div class="form-layout-footer text-right mg-t-20">
                                                <button type="button" id="btnprevcer_bono" name="btnprevcer_bono"  class="btn btn-secondary mg-l-10">Previsualizar</button>
                                                ...
                                                <div class="row ">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row mg-b-5">
                                                            ...
                                                            <div class="col-lg-6 pd-0">
                                                                <select class="form-control col-lg-6 select2" data-placeholder="Seleccione" id="select_mes_boleta" name="select_mes_boleta" style="width: 100%" onchange="MostrarBoleta()">
                                                                    <option label="Seleccione"></option>
                                                ...
                                                <div class="row pd-t-5">
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            ...
                                                            <input class="form-control col-sm-6" type="number" id="dic_91" name="dic_91" oninput="calcularBono()" placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Junio '92: <span class="tx-danger">*</span></label>
                                                            <input class="form-control col-lg-6" type="number" id="jun_92" name="jun_92" oninput="calcularBono()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Enero '92: </label>
                                                            <input class="form-control col-lg-6" type="number" id="ene_92" name="ene_92" oninput="calcularBono()" placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Julio '92:</label>
                                                            <input class="form-control col-lg-6" type="number" id="jul_92" name="jul_92" oninput="calcularBono()"   placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Febrero '92: </label>
                                                            <input class="form-control col-lg-6" type="number" id="feb_92" name="feb_92" oninput="calcularBono()" placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Agosto '92:</label>
                                                            <input class="form-control col-lg-6" type="number" id="ago_92" name="ago_92"  oninput="calcularBono()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Marzo '92: </label>
                                                            <input class="form-control col-lg-6" type="number" id="mar_92" name="mar_92" oninput="calcularBono()" placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Septiembre '92:</label>
                                                            <input class="form-control col-lg-6" type="number" id="sep_92" name="sep_92" oninput="calcularBono()"   placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Abril '92:</label>
                                                            <input class="form-control col-lg-6" type="number" id="abr_92" name="abr_92" oninput="calcularBono()" placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Octubre '92:</label>
                                                            <input class="form-control col-lg-6" type="number" id="oct_92" name="oct_92"  oninput="calcularBono()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Mayo '92: </label>
                                                            <input class="form-control col-lg-6" type="number" id="may_92" name="may_92" oninput="calcularBono()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-6">
                                                        <div class="row mg-b-5">
                                                            <label class="form-control-label col-lg-6">Noviembre '92:</label>
                                                            <input class="form-control col-lg-6" type="number" id="nov_92" name="nov_92"  oninput="calcularBono()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                </div><!-- row -->
                                                <div class="row mg-t-15">
                                                    <div class="col-12 col-sm-8">
                                                        <div class="row mg-b-15">
                                                            ...
                                                            <input class="form-control col-lg-6" type="number" id="cal_bono" name="cal_bono"    placeholder="Calculo Bono" >
                                                        </div>
                                                    </div><!-- col-4 -->
