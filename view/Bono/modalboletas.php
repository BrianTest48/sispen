                                ...
                                <div class="table-wrapper">
                                    <table class="table display responsive nowrap" id="tabla_boleta" style="width: 100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Sueldo</td>
                                                <td><input id="dic_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('dic')"></td>
                                                <td><input id="ene_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('ene')"></td>
                                                <td><input id="feb_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('feb')"></td>
                                                <td><input id="mar_1" class="table_row conceptos" type="text" value="280" oninput="Sumarmonto('mar')"></td>
                                                <td><input id="abr_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('abr')"></td>
                                                <td><input id="may_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('may')"></td>
                                                <td><input id="jun_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('jun')"></td>
                                                <td><input id="jul_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('jul')"></td>
                                                <td><input id="ago_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('ago')"></td>
                                                <td><input id="sep_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('sep')"></td>
                                                <td><input id="oct_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('oct')"></td>
                                                <td><input id="nov_1" class="table_row conceptos" type="text" value="380" oninput="Sumarmonto('nov')"></td>
                                            </tr>
                                            <tr>
                                                <td>RM. Vacacional</td>'
                                                <td><input id="dic_2" class="table_row conceptos" type="text" value="50"    oninput="Sumarmonto('dic')"></td>
                                                <td><input id="ene_2" class="table_row conceptos" type="text" value="50"    oninput="Sumarmonto('ene')"></td>
                                                <td><input id="feb_2" class="table_row conceptos" type="text" value="35"    oninput="Sumarmonto('feb')"></td>
                                                <td><input id="mar_2" class="table_row conceptos" type="text" value="916"   oninput="Sumarmonto('mar')"></td>
                                                <td><input id="abr_2" class="table_row conceptos" type="text" value="700"   oninput="Sumarmonto('abr')"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="feb_3" class="table_row conceptos" type="text" value="500"  oninput="Sumarmonto('feb')"></td>
                                                <td><input id="mar_3" class="table_row conceptos" type="text" value="0"     oninput="Sumarmonto('mar')"></td>
                                                <td><input id="abr_3" class="table_row conceptos" type="text" value="500"  oninput="Sumarmonto('abr')"></td>
                                                <td><input id="may_3" class="table_row conceptos" type="text" value="260"  oninput="Sumarmonto('may')"></td>
                                                <td><input id="jun_3" class="table_row conceptos" type="text" value="180"  oninput="Sumarmonto('jun')"></td>
                                                <td><input id="jul_3" class="table_row conceptos" type="text" value="0"     oninput="Sumarmonto('jul')"></td>
                                                <td><input id="ago_3" class="table_row conceptos" type="text" value="150"  oninput="Sumarmonto('ago')"></td>
                                                <td><input id="sep_3" class="table_row conceptos" type="text" value="0"     oninput="Sumarmonto('sep')"></td>
                                                <td><input id="oct_3" class="table_row conceptos" type="text" value="98"   oninput="Sumarmonto('oct')"></td>
                                                <td><input id="nov_3" class="table_row conceptos" type="text" value="406"  oninput="Sumarmonto('nov')"></td>
                                            </tr>
                                            <tr>
                                                <td>H. Extras</td>
                                                <td><input id="dic_4" class="table_row conceptos" type="text" value="900"  oninput="Sumarmonto('dic')"></td>
                                                ...
                                                <td><input id="oct_4" class="table_row conceptos" type="text" value="48"   oninput="Sumarmonto('oct')"></td>
                                                <td><input id="nov_4" class="table_row conceptos" type="text" value="0"     oninput="Sumarmonto('nov')"></td>
                                            </tr>
                                            <tr>
                                                <td>Bonificacion</td>
                                                <td><input id="dic_5" class="table_row conceptos" type="text" value="590" oninput="Sumarmonto('dic')"></td>
                                                <td><input id="ene_5" class="table_row conceptos" type="text" value="590" oninput="Sumarmonto('ene')"></td>
                                                <td><input id="feb_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('feb')"></td>
                                                <td><input id="mar_5" class="table_row conceptos" type="text" value="0"    oninput="Sumarmonto('mar')"></td>
                                                <td><input id="abr_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('abr')"></td>
                                                <td><input id="may_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('may')"></td>
                                                <td><input id="jun_5" class="table_row conceptos" type="text" value="720" oninput="Sumarmonto('jun')"></td>
                                                <td><input id="jul_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('jul')"></td>
                                                <td><input id="ago_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('ago')"></td>
                                                <td><input id="sep_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('sep')"></td>
                                                <td><input id="oct_5" class="table_row conceptos" type="text" value="680" oninput="Sumarmonto('oct')"></td>
                                                <td><input id="nov_5" class="table_row conceptos" type="text" value="480" oninput="Sumarmonto('nov')"></td>
                                            </tr>
                                            <tr>
                                                <td>Otros</td>
                                                ...
                                                <td><input id="oct_6" class="table_row conceptos" type="text" value="46" oninput="Sumarmonto('oct')"></td>
