...
<html lang="es">
    ...
    <title>SDBZ  - Creacion Boleta</title>
    </head>
    <body >
    <?php 
    ...
    ?>
        ...
        <div class="br-mainpanel">
            <div class="br-pageheader pd-y-15 pd-l-20">
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Plantilla Boleta</span>
                </nav>
            </div><!-- br-pageheader -->
            <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 class="tx-gray-800 mg-b-5">Plantillas Boleta</h4>
                <p class="mg-b-0">Desde esta ventana podra observar las plantillas de Boleta</p>
            </div>
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Plantilla - Boleta</h6>
                    ...
                    <div class="table-wrapper" >
                        <table id="boleta_data" class="table display responsive nowrap" style="width: 100%">
                            <thead>
                                <tr>
        ...
        ?>
        <script src="./docboleta.js"></script>
  </body>
</html>