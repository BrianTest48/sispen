...
$(document).ready(function(){ 
    tabla=$('#logo_data').dataTable({
        ...
        "ajax":{
            url: '../../controller/fondocontrolador.php?op=listar',
            type : "get",
            dataType : "json",
            error: function(e){
                console.log(e);
...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../controller/fondocontrolador.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function editar(logo_id){
    ...
    $.post("../../controller/fondocontrolador.php?op=mostrar",{logo_id: logo_id},function(data){
...
function eliminar(logo_id){
    swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.post("../../controller/fondocontrolador.php?op=eliminar",{logo_id:logo_id},function (data) {
