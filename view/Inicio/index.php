...
<html lang="es">
    ...
    <body class="fondo">
        ...
        <div class="br-mainpanel">
            <div class="pd-30">
            <h4 class="tx-gray-800 mg-b-5">Inicio</h4></div>
                ...
                <div class="row row-sm mg-t-20">
                    ...
                    <div class="col-4">
                        <div class="card bd-0 shadow-base pd-30">
                            <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Estado de Productos</h6>
                            <p class="mg-b-25">Cantidad de Productos por cada categoria</p>
                            <div id="stats_productos"></div>
        ...
        <script src="../../public/lib/chartist/chartist.js"></script>
        <script src="../../public/lib/jquery.sparkline.bower/jquery.sparkline.min.js"></script>
