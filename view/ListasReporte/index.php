...
<html lang="es">
    ...
    <title>SDBZ  - Listas Reporte</title>
    </head>
    <body >
    <?php 
        ...
        <div class="br-mainpanel">
            <div class="br-pageheader pd-y-15 pd-l-20">
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Listas Reporte</span>
                </nav>
            </div><!-- br-pageheader -->
            <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 class="tx-gray-800 mg-b-5">Listas Reporte</h4>
                        ...
                        <table id="lista_data" class="table display responsive nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-5p">Fecha Orc</th>
                                    <th class="wd-5p">F.Final Orc</th>
                                    <th class="wd-5p">Ruc Orc</th>
                                    <th class="wd-5p">Cargo Orc</th>
                                    <th class="wd-5p">Firmante Orc</th>
                                    <th class="wd-5p">Logo Orc</th>
                                    <th class="wd-5p">Fecha Host</th>
                                    <th class="wd-5p">F.Final Host</th>
                                    <th class="wd-5p">Ruc Host</th>
                                    <th class="wd-5p">Cargo Host</th>
                                    <th class="wd-5p">Firmante Host</th>
                                    <th class="wd-5p">Logo Host</th>
                                    <th class="wd-5p">Meses Reflex</th>
