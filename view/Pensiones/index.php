                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row mg-b-5">
                                                            ...
                                                            <input class="form-control col-lg-6" type="number" name="reintegro_boleta" id="reintegro_boleta" oninput="calcularTotalBoleta()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-12">
                                                        <div class="row mg-b-5">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row mg-b-5">
                                                            ...
                                                            <input class="form-control col-lg-6" type="number" name="boni_boleta" id="boni_boleta" oninput="calcularTotalBoleta()"  placeholder="" >
                                                        </div>
                                                    </div><!-- col-4 -->
                                                    <div class="col-lg-12">
                                                        <div class="row mg-b-5">
