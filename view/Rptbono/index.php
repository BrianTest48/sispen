                                        ...
                                        <div class="card" style="margin-top: 60px;">
                                            ...
                                            <div id="contenido_bono_3" class="card-body m-5 p-5">
                                                ...
                                                <div class="text-center">
                                                    <div style="text-align: center !important;">
                                                        <h1 style="color: #000;font-weight: 600;font-size: 20px;"><u>DECLARACIÓN JURADA DEL EMPLEADOR</u></h1>
                                                        <p style="color: #000;font-weight: 600;font-size: 13px;">(SUPREMO N° <span style="color: #FF0000;font-weight: 600;font-size: 16px;">______</span> - EF, Bono <span style="color: #FF0000;font-weight: 600;font-size: 16px;">_______ </span> )</p>
