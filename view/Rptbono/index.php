...
<html lang="es">
    ...
    <body>
        ...
        <div class="br-mainpanel">
            <div class="br-pageheader pd-y-15 pd-l-20">
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Reporte de Bono</span>
                </nav>
            </div><!-- br-pageheader -->
            <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 class="tx-gray-800 mg-b-5">Reportes Bono</h4>
                <p class="mg-b-0">Introduce los siguientes datos para generar los bonos.</p>
            </div>
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    <div class="row justify-content-between">
                        <div class="col-12 col-sm-6">
                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Formulario - Reporte Bono</h6>
                        </div>
                    ...
                    <div class="row ">
                        <div class="col-xl-6">
                            <input type="hidden" id="tipo_lista" name="tipo_lista" value="REPORTE BONO">
                            <form method="post" id="rpt_pension_form">
                                <div class="form-layout form-layout-1 pd-b-0" style="padding-bottom: 0px">
                                ...
                                <div class="form-layout form-layout-4 mg-t-10 "  style="padding-bottom: 0px">
                                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">Datos Personales</h6>
                                    <p class="mg-b-30 tx-gray-600">Registre los siguientes datos personales:</p>
                                    <div class="row mg-t-15 pd-b-0">
                                    ...
                                    <div class="row mg-t-15 ">
                                        <label class="col-sm-4 form-control-label">Fecha de Nacimiento: <span class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="date" max="2999-12-31" class="form-control" id="txtdate" name="txtdate" >
                                        </div>
                                    </div>
                                    <div  class="row mg-t-15" hidden>
                                        <label class="col-sm-4 form-control-label">Cant. de Años: <span class="tx-danger">*</span></label>
                                        <div class="col-sm-8 ">
                            ...
                            <div>
                                ...
                                <br>
                                <div class="form-layout form-layout-1" id="divresultado_emp">
                                        <div class="accordion" id="acc_resultado" >
                                            
                                        </div>
                                    </div>
                                <div class="" id="divresultadoEmpresa">
                        ...
                        <div class="col-xl-6 mg-t-20 mg-xl-t-0">
                            <div id="datosEmpresas" class="form-layout form-layout-4 " style="padding-bottom: 38px" >
                                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Datos de la Empresa</h6>
                                <p class="mg-b-30 tx-gray-600">Se visualizan los datos de la empresa</p>
                                <div class="row">
                                    <label class="col-sm-4 form-control-label">Orcinea</label>
                                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                        <input readonly type="text" class="form-control" id="cant_orcinea" name="cant_orcinea" placeholder="">
                                    </div>
                                </div><!-- row -->
                                <div class="row mg-t-30">
                                    <label class="col-sm-4 form-control-label">Host:</label>
                                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                        <input readonly type="text" class="form-control" id="cant_host"  name="cant_host" placeholder="">
                                    </div>
                                </div>
                                <!--<div class="row mg-t-30">
                                    <label class="col-sm-4 form-control-label">Reflex:</label>
                                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                        <input readonly type="text" class="form-control" id="cant_reflex"  name="cant_reflex" placeholder="">
                                    </div>
                                </div>-->
                                <div class="row mg-t-30">
                                    <label class="col-sm-4 form-control-label">Empresa:</label>
                                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                        <input readonly type="text" class="form-control" id="tiempo_Empresa" placeholder="">
                                    </div>
                                </div>
                                <div class="row mg-t-30">
                                    <label class="col-sm-4 form-control-label">Total:</label>
                                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                        <input readonly type="text" class="form-control" id="total_tiempo" name="total_tiempo" placeholder="">
                                    </div>
                                </div><!-- row -->
                            </div><!-- form-layout -->
                            <br>
                            <div id="" class="" style="" >
                                <div id="contemp1" name="contemp1" class="form-layout form-layout-1">
                                    ...
                                    <div class="tab-content">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="row mg-b-5">
                                                                ...
                                                                <div class="col-lg-6 pd-0">
                                                                    <select class="form-control col-lg-6 select2" data-placeholder="Seleccione" id="select_certificado" name="select_certificado" style="width: 100%">
                                                                        <!--<option value="0">Certificado - 0</option>-->
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="row mg-b-5">
                                                                ...
                                                                <div class="col-lg-6 pd-0">
                                                                    <select class="form-control col-lg-6 select2" data-placeholder="Seleccione" id="select_mes_boletas_rpt_bono" name="select_mes_boletas_rpt_bono" style="width: 100%" onchange="MostrarBoleta()">
                                                                    <option label="Seleccione"></option>
                                                                        <option value="dic">Diciembre  1991</option>
                                                                        <option value="ene">Enero - 1992</option>
                                                                        <option value="feb">Febrero - 1992</option>
                                                                        <option value="mar">Marzo - 1992</option>
                                                                        <option value="abr">Abril - 1992</option>
                                                                        <option value="may">Mayo - 1992</option>
                                                                        <option value="jun">Junio - 1992</option>
                                                                        <option value="jul">Julio - 1992</option>
                                                                        <option value="ago">Agosto - 1992</option>
                                                                        <option value="sep">Septiembre - 1992</option>
                                                                        <option value="oct">Octubre - 1992</option>
                                                                        <option value="nov">Noviembre - 1992</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div> 
                                        ...
                                        <div id="bono" class="tab-pane fade">
                                            <form id="form_bono" action="" method="post" autocomplete="off">
                                                <div class="form-layout form-layout-4">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-sm-6 ">Numero Autogenerado: <span class="tx-danger">*</span></label>
                                                                <input class="form-control col-sm-6" type="text" id="num_auto" name="num_auto"  placeholder="Numero Aleatorio" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                    </div>
                                                    <div class="row pd-t-5">
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-sm-6">Diciembre '91:</label>
                                                                <input class="form-control col-sm-6" type="number" id="dic_91" name="dic_91" onchange="calcularBono()" placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Junio '92: <span class="tx-danger">*</span></label>
                                                                <input class="form-control col-lg-6" type="number" id="jun_92" name="jun_92" onchange="calcularBono()"  placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Enero '92: </label>
                                                                <input class="form-control col-lg-6" type="number" id="ene_92" name="ene_92" onchange="calcularBono()" placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Julio '92:</label>
                                                                <input class="form-control col-lg-6" type="number" id="jul_92" name="jul_92" onchange="calcularBono()"   placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Febrero '92: </label>
                                                                <input class="form-control col-lg-6" type="number" id="feb_92" name="feb_92" onchange="calcularBono()" placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Agosto '92:</label>
                                                                <input class="form-control col-lg-6" type="number" id="ago_92" name="ago_92"  onchange="calcularBono()"  placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Marzo '92: </label>
                                                                <input class="form-control col-lg-6" type="number" id="mar_92" name="mar_92" onchange="calcularBono()" placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Septiembre '92:</label>
                                                                <input class="form-control col-lg-6" type="number" id="sep_92" name="sep_92" onchange="calcularBono()"   placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Abril '92:</label>
                                                                <input class="form-control col-lg-6" type="number" id="abr_92" name="abr_92" onchange="calcularBono()" placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Octubre '92:</label>
                                                                <input class="form-control col-lg-6" type="number" id="oct_92" name="oct_92"  onchange="calcularBono()"  placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Mayo '92: </label>
                                                                <input class="form-control col-lg-6" type="number" id="may_92" name="may_92" onchange="calcularBono()"  placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-lg-6">
                                                            <div class="row mg-b-5">
                                                                <label class="form-control-label col-lg-6">Noviembre '92:</label>
                                                                <input class="form-control col-lg-6" type="number" id="nov_92" name="nov_92"  onchange="calcularBono()"  placeholder="" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                    </div><!-- row -->
                                                    <div class="row mg-t-15">
                                                    <div class="col-12 col-sm-8">
                                                            <div class="row mg-b-15">
                                                                <label class="form-control-label col-lg-6 text-center">Calculo Bono:</label>
                                                                <input class="form-control col-lg-6" type="number" id="cal_bono_1" name="cal_bono_1"    placeholder="Calculo Bono" >
                                                            </div>
                                                        </div><!-- col-4 -->
                                                        <div class="col-4 col-sm-4">
                                                            <div class="row justify-content-center mg-l-10">
                                                                <button type="button" id="btncalculobono" name="btncalculobono"  class="btn btn-info">Ver Calculo</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-layout-footer text-right mg-t-20">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-4">
                                                            <button type="button" id="btnprevbono" name="btnprevbono"  class="btn btn-secondary">Previsualizar</button>
                                                        </div>
                                                    </div>
                                                    <!--<button type="button" id="btnimprimirbono" name="btnimprimirbono"  class="btn btn-info">Imprimir Bono</button>-->
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div clas="prevs_bonos" id="prev4">
                                    <div class="container prev_bono" style="max-width: 1020px !important;" id="prev_bono_1" >
                                        ...
                                        <div id="contenido_bono_1" class="card-body m-5 p-5">
                                            <div class="text-center">
                                                <div>
                                                    <p style="color: #000;font-weight: 600;font-size: 19px;">DECLARACION JURADA DEL<br>EMPLEADOR</p>
                                                </div>
                                                <div  style="text-align: center !important;">
                                                    <h1 style="color: #000;font-weight: 600;font-size: 13px;">(Supremo N° 054-07-Cf, Bono 1990)</h1>
                                                </div>
                                                <div  style="text-align: center !important;">
                                                    <h1 style="color: #000;font-weight: 600;font-size: 13px;">(Para Los Fines Señalados En La Segunda Disposición Final Y Transitoria Del Decreto)</h1>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="text-center">
                                                <div  style="text-align: justify !important;">
                                                    <p style="color: #000;font-weight: 600;font-size: 13px;">Por la presente, yo
                                                        <u class="nom_emp_ap_rp"></u>
                                                        , identificado con
                                                        <u class="dni_imp_rp"></u>
                                                        en calidad de Representante Legal de la Empresa
                                                        <u class="emp_imp"></u>
                                                        identificada con Registro Único de Contribuyente - R.U.C. - N°
                                                        <u class="ruc_emp_imp"></u>
                                                        . Declaro bajo juramento que el señor(a)
                                                        <u class = "nombre_imp"></u>
                                                        , identificado con
                                                        <u class="dni_imp"></u>
                                                        . código ESSALUD N°
                                                        <u>3545454532</u>
                                                        y Código Único del SPP (CUSPP) N°
                                                        <u>121232324334</u>
                                            ...
                                            <div class="d-flex justify-content-center bd-highlight mb-3d-flex justify-content-center bd-highlight mb-3">
                                                ...
                                                <div class="bd-highlight" style="padding-left: 10px;">
                                                    <h1 style="color: #000;font-weight: 600;font-size: 13px; text-align: left !important;">Bono de Reconocimiento 1992 (Decreto Supremo N°180-94-EF)</h1>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-center bd-highlight mb-3d-flex justify-content-center bd-highlight mb-3">
                                                <div class="p-2 bd-highlight d-flex align-items-center" style="border-top: 1px solid black; border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; height: 10px; width: 70px;"></div>
                                                <div class="bd-highlight" style="padding-left: 10px;">
                                                    <h1 style="color: #000;font-weight: 600;font-size: 13px; text-align: left !important;">Bono de Reconocimiento 1998 (Decreto Supremo N°054-97-EF)</h1>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-center bd-highlight mb-3d-flex justify-content-center bd-highlight mb-3">
                                                <div class="p-2 bd-highlight d-flex align-items-center" style="border-top: 1px solid black; border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; height: 10px; width: 70px;"></div>
                                                <div class="bd-highlight" style="padding-left: 10px;">
                                                    <h1 style="color: #000;font-weight: 600;font-size: 13px; text-align: left !important;">Bono de Reconocimiento 2001 (Decreto Supremo N°054-97-EF)</h1>
                                                </div>
                                            </div>
                                            <div>
                                                <div  style="text-align: justify !important;">
                                                    <p style="color: #000;font-weight: 600;font-size: 13px;">Ha laborado en esta empresa como se detalla a continuación:</p>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-6 table-responsive">
                                                        ...
                                                        <p style="margin-bottom: 0px; color: #000;font-weight: 600;font-size: 10px; text-align: justify !important; padding-top: 0;">1/ Incluir todos los meses efectivamente laborados. Incluso hasta la fecha, de ser el caso, para los casos de meses en que no se realizaron retenciones el trabajador sobre su remuneración (p.e. Licencia sin goce de haber)</p>
                                                    </div>
                                                    <div class="col-6 table-responsive">
                                                        ...
                                                        <table class="table table-borderless" style="margin-bottom: 0px; border-top: 1px solid black; border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; height: 10px;width: 100%;">
                                                            ...
                                                            <tbody class="text-center" style="font-size: 12px;">
                                                                <tr>
                                                                    ...
                                                                    <th scope="row" style="padding-bottom: 0px;" class="dic_91_imp"></th>
                                                                    <th scope="row" style="padding-bottom: 0px;" class="dic_91_imp_rst"></th>
                                                                </tr>
                                                                <tr>
                                                                <th scope="row" style="padding-bottom: 0px;">01</th>
                                                                <th scope="row" style="padding-bottom: 0px;">92</th>
                                                                <th  scope="row" style="padding-bottom: 0px;" class="ene_92_imp"></th>
                                                                <th scope="row" style="padding-bottom: 0px;" class="ene_92_imp_rst"></th>
                                                                </tr>
                                                                <tr>
                                                                <th scope="row" style="padding-bottom: 0px;">02</th>
                                                                <th scope="row" style="padding-bottom: 0px;">92</th>
                                                        ...
                                                        <p style="margin-bottom: 0px; color: #000;font-weight: 600;font-size: 10px; text-align: justify !important; padding-top: 0;">1/ Solo llenar para el caso de las generadas con anterioridad al 06 de Dic. 92, consecutivo o no.</p>
                                                        <p style="margin-bottom: 0px; color: #000;font-weight: 600;font-size: 10px; text-align: justify !important;">2/ Considérese como remuneración, todos los pagos realizados en ese mes (Básico, gratificaciones, etc.) que estuvieron afectos al descuento por IPSS-Pensiones.</p>
                                                        <p style="margin-bottom: 0px; color: #000;font-weight: 600;font-size: 10px; text-align: justify !important;">3/ Señalar la retención efectuada al trabajador por concepto de pensiones IPSS, sobre la remuneración de ese mes.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="text-center">
                                                <div  style="text-align: justify !important;">
                                                    <p style="color: #000;font-weight: 600;font-size: 13px;">Por lo demás, declaro que en los meses q que se hace referencia anteriormente se ha realizado las retenciones por concepto de los aportes a algunos de los Sistemas de Pensiones administrados por la ONP.</p>
                                                </div>
                                            </div>
                                            <br><br><br>
                                            <div>
                                                <div class="row justify-content-end">
                                                    <div class="col-4">
                                                        <p style="color: #000;font-weight: 600;font-size: 12px;">.....................................................................................</p>
                                                        <p style="color: #000;font-weight: 600;font-size: 12px; text-align: center;">Firma y Sello del Representante legal</p>
                                                    </div>
                                                </div>
                                            </div>  
                                        </div>
                                    ...
                                    <div class="container prev_bono" style="max-width: 1020px !important;" id="prev_bono_2">
                                        <div class="card" style="margin-top: 60px;">
                                            <div class="card-header d-flex justify-content-between">
                                                <h3>PREVISUALIZACIÓN</h3>
                                                <div>
                                            ...
                                            <div id="contenido_bono_2" class="card-body m-5 p-5">
                                                ...
                                                <div class="text-center">
                                                    <div style="text-align: center !important;">
                                                        ...
                                                        <p style="color: #000;font-weight: 600;font-size: 13px;">(Para los fines señalados en el Art. <span style="color: #FF0000;font-weight: 600;font-size: 16px;">_________</span> - EF/SAFP)</p>
                                                ...
                                                <div class="text-center">
                                                    <div style="text-align: justify !important;">
                                                        <p style="color: #000;font-weight: 600;font-size: 13px;">Por la presente yo 
                                                            ...
                                                            </span> Y Código único SPP N° <span style="color: #FF0000;font-weight: 600;font-size: 13px;">__________
                                                        </span>, ha elaborado en esta empresa los periodos que se detallan a continuación. </p>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="col-12">
                                                ...
                                                <div class="text-center">
                                                    <div style="text-align: justify !important;">
                                                        <p style="color: #000;font-weight: 600;font-size: 13px;">Por lo demás, declaro que en los meses a que se hace referencia anteriormente, se han realizado las retenciones por concepto de los aportes a alguno de los sistemas de pensiones administrativos por el IPSS</p>
                                                    </div>
                                                    <br><br>
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                    ...
                                    <div class="container prev_bono" style="max-width: 1020px !important;" id="prev_bono_3">
                                        <div class="card" style="margin-top: 60px;">
                                            <div class="card-header d-flex justify-content-between">
                                                <h3>PREVISUALIZACIÓN</h3>
                                                <div>
                                            ...
                                            <div id="contenido_bono_3" class="card-body m-5 p-5">

                                                <div class="text-center">
                                                    <div style="text-align: center !important;">
                                                        <h1 style="color: #000;font-weight: 600;font-size: 20px;"><u>DECLARACIÓN JURADA DEL EMPLEADOR</u></h1>
                                                        <p style="color: #000;font-weight: 600;font-size: 13px;">(SUPREMO N° <span style="color: #FF0000;font-weight: 600;font-size: 16px;">______ </span> - EF, Bono <span style="color: #FF0000;font-weight: 600;font-size: 16px;">________ </span> )</p>
                                                        <p style="color: #000;font-weight: 600;font-size: 13px;">(Para los fines señalados en la Segunda Disposición Final y Transitoria del Decreto)</p>
                                                    </div>
                                                </div>
                                                <br>
        ...
        ?>
        <script src="rptbono.js" type="text/javascript"></script>
    </body>
</html>