...
$(document).ready(function(){ 
   ...
   // $("#div_logo_host").hide();
    ...
    $('#select_mes_boletas_rpt_bono').select2({
                                ...
                                '<form id="form_orci_'+i+'" action="" method="post" autocomplete="off">'+
                                    '<div class="pd-15">'+
                                        ...
                                        '<div class="row mb-3 mt-2">'+
                                            ...
                                            '<div class="col-lg-9">'+
                                                '<input type="text"  id="firmante_orcinea_'+i+'" class="form-control  firmante_orcinea" >'+
                                                '</input>'+
                                            '</div>'+
                                        '</div>'+
                                        '<div class="row mb-3 mt-2">'+
...
function imprimir_boleta(){
    ...
    let tipoprev1 = $('#combo_prev_boleta').val();
...
function MostrarBoleta(){
    let mes = $('#select_mes_boletas_rpt_bono').val();
