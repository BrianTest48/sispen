...
<html lang="es">
    <head>
        ...
        <title>SDBZ  - Reporte  Pensiones</title>
    </head>
    <body>
        <?php 
        ...
        <div class="br-mainpanel">
            <div class="br-pageheader pd-y-15 pd-l-20">
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Reporte de Pension</span>
                </nav>
            </div><!-- br-pageheader -->
            <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 class="tx-gray-800 mg-b-5">Reportes Pensiones</h4>
                <p class="mg-b-0">Introduce los siguientes datos para generar las pensiones.</p>
            </div>
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    ...
                    <div class="row ">
                        <div class="col-xl-6">
                            <input type="hidden" id="tipo_lista" name="tipo_lista" value="REPORTE PENSIONES">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div id="reflex">
                                                    <form id="form_reflex" action="" method="post" autocomplete="off">
                                                        <div class="pd-15">
                                                            <div class="row mg-b-25">
                                                                <div class="col-lg-8">
                                                                    <div class="form-group mg-b-10-force">
                                                                        <label class="form-control-label">Meses Trabajados: <span class="tx-danger">*</span></label>
                                                                        <input class="form-control" type="number"  id="cant_meses" name="cant_meses"  placeholder="" >
                                                                    </div>
                                                                </div><!-- col-8 -->
																...
																<div class="row d-flex justify-content-center">
																	<div class="col-lg-4 text-center">
																		<br>
																		<button class="btn btn-secondary btn-block mg-b-10" type="button" id="btnLimpiarReflex" name="btnLimpiarReflex" onclick="LimpiarCamposReflex()">Limpiar</button>
																	</div><!-- col-4 -->

																	<div class="col-lg-4 text-center">
																		<br>
																		<button class="btn btn-info btn-block mg-b-10" type="button" id="btncargarreflex">Registrar</button>
																	</div><!-- col-4 -->
																</div>
                                                        ...
                                                        <div class="row ">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row mg-b-5">
                                                                    ...
                                                                    <div class="col-lg-6 pd-0">
                                                                        <select class="form-control col-lg-6 select2" data-placeholder="Seleccione" id="select_mes_boleta_1" name="select_mes_boleta_1" style="width: 100%" onchange="MostrarBoleta()">
                                                                            <option label="Seleccione"></option>
        ...
        <!--<script language="javascript">
            $(function(){
                try{
                    $("body #comboimg").msDropDown();
                }catch(e){
                    alert(e.message);
                }
            });
        </script>-->
        <script src="rptpension.js" type="text/javascript"></script>
    </body>
</html>